        ...
        <div className="mb-16 md:mb-20">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            <div className="flex items-start gap-4 p-5 bg-white rounded-lg border border-beige-200 hover:border-black/30 hover:shadow-lg transition-all duration-300 group card-hover-lift">
              ...
              <div>
                <h3 className="font-semibold text-black mb-1.5 text-base">Преміальна якість</h3>
                <p className="text-sm text-black/60 leading-relaxed">Тільки найкращі матеріали</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-5 bg-white rounded-lg border border-beige-200 hover:border-black/30 hover:shadow-lg transition-all duration-300 group card-hover-lift">
              ...
              <div>
                <h3 className="font-semibold text-black mb-1.5 text-base">Досвідчені майстри</h3>
                <p className="text-sm text-black/60 leading-relaxed">Професійний підхід</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-5 bg-white rounded-lg border border-beige-200 hover:border-black/30 hover:shadow-lg transition-all duration-300 group card-hover-lift">
              ...
              <div>
                <h3 className="font-semibold text-black mb-1.5 text-base">Відмінний результат</h3>
                <p className="text-sm text-black/60 leading-relaxed">Гарантія задоволення</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-5 bg-white rounded-lg border border-beige-200 hover:border-black/30 hover:shadow-lg transition-all duration-300 group card-hover-lift">
              ...
              <div>
                <h3 className="font-semibold text-black mb-1.5 text-base">Індивідуальний підхід</h3>
                <p className="text-sm text-black/60 leading-relaxed">Персональний догляд</p>
              </div>
            </div>
          </div>
        </div>
